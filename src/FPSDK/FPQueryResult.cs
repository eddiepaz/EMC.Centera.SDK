...
namespace EMC.Centera.SDK
{
  public class FPQueryResult : FPObject
  {
    ...
    /// </summary>
    public FPQueryResult() => this.theResult = 0;
    ...
    internal FPQueryResultRef Result
    {
      set
      {
        ...
        this.AddObject( this.theResult, this );
      }
    }
    ...
    /// </summary>
    public static implicit operator FPQueryResultRef( FPQueryResult q ) => q.theResult;
    ...
    public override void Close()
    {
      if( this.theResult != 0 )
      {
        this.RemoveObject( this.theResult );
        Native.QueryResult.Close( this.theResult );
        this.theResult = 0;
      }
    }
    ...
    public string ClipID
    {
      get
      {
        ...
        Native.QueryResult.GetClipID( this.theResult, outClipID );
    ...
    ///
    /// </summary>
    public DateTime Timestamp => FPMisc.GetDateTime( Native.QueryResult.GetTimestamp( this.theResult ) );
    ...
    public string GetField( string inAttrName )
    {
      ...
      do
      {
        ...
        Native.QueryResult.GetField( this.theResult, inAttrName, ref outString, ref len );
      } while( len > bufSize );
    ...
    ///
    /// </summary>
    public int ResultCode => (int) Native.QueryResult.GetResultCode( this.theResult );
    ...
    ///
    /// </summary>
    public bool Exists => Native.QueryResult.GetType( this.theResult ) == (FPInt) FPMisc.QUERY_TYPE_EXISTING;

    /// <inheritdoc />
    public override string ToString() =>
      "Clip: " + this.ClipID +
      " Status(" + (this.Exists ? "EXISTS" : "DELETED") + ")" +
