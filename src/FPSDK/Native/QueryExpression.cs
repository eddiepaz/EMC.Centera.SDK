...
namespace EMC.Centera.SDK.Native
{
    public class QueryExpression
    {
        ...
        {
            var retval = SDK.FPQueryExpression_Create();
        ...
        {
            var retval = SDK.FPQueryExpression_GetStartTime(inRef);
            SDK.CheckAndThrowError();
            return retval;
        }
        public static FPLong GetEndTime(FPQueryExpressionRef inRef)
        {
            var retval = SDK.FPQueryExpression_GetEndTime(inRef);
            SDK.CheckAndThrowError();
            return retval;
        }
        public static FPInt GetType(FPQueryExpressionRef inRef)
        {
            var retval = SDK.FPQueryExpression_GetType(inRef);
            SDK.CheckAndThrowError();
            return retval;
        }
        ...
        {
            var retval = SDK.FPQueryExpression_IsFieldSelected8(inRef, inFieldName);
            SDK.CheckAndThrowError();
            return retval;
        }
