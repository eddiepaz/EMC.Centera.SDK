...
namespace EMC.Centera.SDK
{
  public class FPLogger : FPObject
  {
    ...
    /// </summary>
    public static implicit operator FPLogStateRef( FPLogger l ) => l.TheLogger;
    ...
    {
      // Find the relevant Logger object in the hashtable for this LogStateRef
      FPLogger logObject;

      if( FPObject.SDKObjects.Contains( logRef ) )
      {
        logObject = (FPLogger) FPObject.SDKObjects[logRef];
      }
      else
      {
        throw new FPLibraryException( "FPLogStateRef is not associated with an FPLogger object", FPMisc.WRONG_REFERENCE_ERR );
      }
    ...
    /// <summary>
    ///Static method to stop the SDK logging
    ...
    {
      get => Native.Logging.GetAppendMode( this );
      set => Native.Logging.SetAppendMode( this, value );
    }
    ...
    {
      get => Native.Logging.GetDisableCallback( this );
      set => Native.Logging.SetDisableCallback( this, value );
    }
    ...
    {
      get => Native.Logging.GetLogFilter( this );
      set => Native.Logging.SetLogFilter( this, value );
    }
    ...
    {
      get => Native.Logging.GetLogLevel( this );
      set => Native.Logging.SetLogLevel( this, value );
    }
    ...
    {
      get => Native.Logging.GetLogPath( this );
      set => Native.Logging.SetLogPath( this, value );
    }
    ...
    {
      get => Native.Logging.GetMaxLogSize( this );
      set => Native.Logging.SetMaxLogSize( this, value );
    }
    ...
    {
      get => Native.Logging.GetMaxOverflows( this );
      set => Native.Logging.SetMaxOverflows( this, value );
    }
    ...
    {
      get => Native.Logging.GetPollInterval( this );
      set => Native.Logging.SetPollInterval( this, value );
    }
