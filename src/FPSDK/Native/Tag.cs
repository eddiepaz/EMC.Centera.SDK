...
namespace EMC.Centera.SDK.Native
{
    public class Tag
    {
        ...
        {
            var retval = SDK.FPTag_GetClipRef(inTag);
            SDK.CheckAndThrowError();
            return retval;
        }
        public static FPTagRef GetSibling(FPTagRef inTag)
        {
            var retval = SDK.FPTag_GetSibling(inTag);
            SDK.CheckAndThrowError();
            return retval;
        }
        public static FPTagRef GetPrevSibling(FPTagRef inTag)
        {
            var retval = SDK.FPTag_GetPrevSibling(inTag);
            SDK.CheckAndThrowError();
            return retval;
        }
        ...
        {
            var retval = SDK.FPTag_GetLongAttribute8(inTag, inAttrName);
            SDK.CheckAndThrowError();
            return retval;
        }
