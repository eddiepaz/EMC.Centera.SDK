...
namespace EMC.Centera.SDK
{
  ...
  public class FPMisc
  {
    ...
    /// </summary>
    public static DateTime GetDateTime( FPLong l ) => FPMisc.Epoch.Add( new TimeSpan( (long) l * 10000 ) );
    ...
    ///@return An FPLong representing the converted DateTime object.
    /// </summary>
    public static FPLong GetTime( DateTime d ) => (FPLong) ((d.Ticks - FPMisc.Epoch.Ticks) / 10000);
    ...
    {
      var retval = (long) Native.FP.FPTime_StringToSeconds( inTime );
      return retval;
    }
    /// <summary>
    ...
    ///@return A long representing the Time value (number of seconds since the UNIX Epoch).
    /// </summary>
    public static long FPTime_StringToSeconds( string inTime ) => FPMisc.FPTime_StringToLong( inTime );
    ...
    {
      var retval = (long) Native.FP.FPTime_StringToMilliseconds( inTime );
      return retval;
    }
    ...
    public const int INVALID_NAME = (int) ((FPMisc.ERROR_BASE - 1));
    public const int UNKNOWN_OPTION = (int) ((FPMisc.ERROR_BASE - 2));
    public const int NOT_SEND_REQUEST_ERR = (int) ((FPMisc.ERROR_BASE - 3));
    public const int NOT_RECEIVE_REPLY_ERR = (int) ((FPMisc.ERROR_BASE - 4));
    public const int SERVER_ERR = (int) ((FPMisc.ERROR_BASE - 5));
    public const int PARAM_ERR = (int) ((FPMisc.ERROR_BASE - 6));
    public const int PATH_NOT_FOUND_ERR = (int) ((FPMisc.ERROR_BASE - 7));
    public const int CONTROLFIELD_ERR = (int) ((FPMisc.ERROR_BASE - 8));
    public const int SEGDATA_ERR = (int) ((FPMisc.ERROR_BASE - 9));
    public const int DUPLICATE_FILE_ERR = (int) ((FPMisc.ERROR_BASE - 10));
    public const int OFFSET_FIELD_ERR = (int) ((FPMisc.ERROR_BASE - 11));
    public const int OPERATION_NOT_SUPPORTED = (int) ((FPMisc.ERROR_BASE - 12));
    public const int ACK_NOT_RCV_ERR = (int) ((FPMisc.ERROR_BASE - 13));
    public const int FILE_NOT_STORED_ERR = (int) ((FPMisc.ERROR_BASE - 14));
    public const int NUMLOC_FIELD_ERR = (int) ((FPMisc.ERROR_BASE - 15));
    public const int SECTION_NOT_FOUND_ERR = (int) ((FPMisc.ERROR_BASE - 16));
    public const int TAG_NOT_FOUND_ERR = (int) ((FPMisc.ERROR_BASE - 17));
    public const int ATTR_NOT_FOUND_ERR = (int) ((FPMisc.ERROR_BASE - 18));
    public const int WRONG_REFERENCE_ERR = (int) ((FPMisc.ERROR_BASE - 19));
    public const int NO_POOL_ERR = (int) ((FPMisc.ERROR_BASE - 20));
    public const int CLIP_NOT_FOUND_ERR = (int) ((FPMisc.ERROR_BASE - 21));
    public const int TAGTREE_ERR = (int) ((FPMisc.ERROR_BASE - 22));
    public const int ISNOT_DIRECTORY_ERR = (int) ((FPMisc.ERROR_BASE - 23));
    public const int UNEXPECTEDTAG_ERR = (int) ((FPMisc.ERROR_BASE - 24));
    public const int TAG_READONLY_ERR = (int) ((FPMisc.ERROR_BASE - 25));
    public const int OUT_OF_BOUNDS_ERR = (int) ((FPMisc.ERROR_BASE - 26));
    public const int FILESYS_ERR = (int) ((FPMisc.ERROR_BASE - 27));
    public const int STACK_DEPTH_ERR = (int) ((FPMisc.ERROR_BASE - 29));
    public const int TAG_HAS_NO_DATA_ERR = (int) ((FPMisc.ERROR_BASE - 30));
    public const int VERSION_ERR = (int) ((FPMisc.ERROR_BASE - 31));
    public const int MULTI_BLOB_ERR = (int) ((FPMisc.ERROR_BASE - 32));
    public const int PROTOCOL_ERR = (int) ((FPMisc.ERROR_BASE - 33));
    public const int NO_SOCKET_AVAIL_ERR = (int) ((FPMisc.ERROR_BASE - 34));
    public const int BLOBIDFIELD_ERR = (int) ((FPMisc.ERROR_BASE - 35));
    public const int BLOBIDMISMATCH_ERR = (int) ((FPMisc.ERROR_BASE - 36));
    public const int PROBEPACKET_ERR = (int) ((FPMisc.ERROR_BASE - 37));
    public const int CLIPCLOSED_ERR = (int) ((FPMisc.ERROR_BASE - 38));
    public const int POOLCLOSED_ERR = (int) ((FPMisc.ERROR_BASE - 39));
    public const int BLOBBUSY_ERR = (int) ((FPMisc.ERROR_BASE - 40));
    public const int SERVER_NOTREADY_ERR = (int) ((FPMisc.ERROR_BASE - 41));
    public const int SERVER_NO_CAPACITY_ERR = (int) ((FPMisc.ERROR_BASE - 42));
    public const int DUPLICATE_ID_ERR = (int) ((FPMisc.ERROR_BASE - 43));
    public const int STREAM_VALIDATION_ERR = (int) ((FPMisc.ERROR_BASE - 44));
    public const int STREAM_BYTECOUNT_MISMATCH_ERR = (int) ((FPMisc.ERROR_BASE - 45));

    public const int NETWORK_ERROR_BASE = (int) (-10100);
    public const int SOCKET_ERR = (int) ((FPMisc.NETWORK_ERROR_BASE - 1));
    public const int PACKETDATA_ERR = (int) ((FPMisc.NETWORK_ERROR_BASE - 2));
    public const int ACCESSNODE_ERR = (int) ((FPMisc.NETWORK_ERROR_BASE - 3));

    public const int SERVER_ERROR_BASE = (int) (-10150);
    public const int OPCODE_FIELD_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 1));
    public const int PACKET_FIELD_MISSING_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 2));
    public const int AUTHENTICATION_FAILED_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 3));
    public const int UNKNOWN_AUTH_SCHEME_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 4));
    public const int UNKNOWN_AUTH_PROTOCOL_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 5));
    public const int TRANSACTION_FAILED_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 6));
    public const int PROFILECLIPID_NOTFOUND_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 7));
    public const int ADVANCED_RETENTION_DISABLED_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 8));
    public const int NON_EBR_CLIP_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 9));
    public const int EBR_OVERRIDE_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 10));
    public const int NO_EBR_EVENT_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 11));
    public const int RETENTION_OUT_OF_BOUNDS_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 12));
    public const int RETENTION_HOLD_COUNT_ERR_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 13));
    public const int METADATA_MISMATCH_ERR = (int) ((FPMisc.SERVER_ERROR_BASE - 14));

    public const int CLIENT_ERROR_BASE = (int) (-10200);
    public const int OPERATION_REQUIRES_MARK = (int) ((FPMisc.CLIENT_ERROR_BASE - 1));
    public const int QUERYCLOSED_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 2));
    public const int WRONG_STREAM_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 3));
    public const int OPERATION_NOT_ALLOWED = (int) ((FPMisc.CLIENT_ERROR_BASE - 4));
    public const int SDK_INTERNAL_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 5));
    public const int OUT_OF_MEMORY_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 6));
    public const int OBJECTINUSE_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 7));
    public const int NOTYET_OPEN_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 8));
    public const int STREAM_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 9));
    public const int TAGCLOSED_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 10));
    public const int THREAD_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 11));
    public const int PROBE_TIME_EXPIRED_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 12));
    public const int PROFILECLIPID_WRITE_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 13));
    public const int INVALID_XML_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 14));
    public const int UNABLE_TO_GET_LAST_ERROR = (int) ((FPMisc.CLIENT_ERROR_BASE - 15));
    public const int LOGGING_CALLBACK_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 16));
    public const int MIGRATION_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 17));
    public const int COLLOCATION_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 18));
    public const int REDIRECTED_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 19));
    public const int INVALID_REDIRECT_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 20));
    public const int FEDERATED_VER_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 21));
    public const int INVALID_FEDERATION_ERR = (int) ((FPMisc.CLIENT_ERROR_BASE - 22));

    public const int UNDEFINED_ERROR_BASE = (int) (-10250);
    public const int ZOS_ERROR_BASE = (int) (-20000);
    public const int SUBTASK_TCB_NOT_FOUND = (int) ((FPMisc.ZOS_ERROR_BASE - 1));
    public const int INVALID_FUNCTION_ID = (int) ((FPMisc.ZOS_ERROR_BASE - 2));
    public const int COMMAREA_MALLOC_ERR = (int) ((FPMisc.ZOS_ERROR_BASE - 3));
    public const int ZOS_SUBTASK_ABEND = (int) ((FPMisc.ZOS_ERROR_BASE - 4));
    public const int ZOS_SUBTASK_UNKN_RC = (int) ((FPMisc.ZOS_ERROR_BASE - 5));
