...
namespace EMC.Centera.SDK.Native
{
  public class Clip
  {
    ...
    {
      var retval = SDK.FPClip_GetPoolRef( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    public static FPBool Exists( FPPoolRef inPool, string inClipID )
    {
      var retval = SDK.FPClip_Exists( inPool, inClipID );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_GetTopTag( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    public static FPInt GetNumBlobs( FPClipRef inClip )
    {
      var retval = SDK.FPClip_GetNumBlobs( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    public static FPInt GetNumTags( FPClipRef inClip )
    {
      var retval = SDK.FPClip_GetNumTags( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    public static FPLong GetTotalSize( FPClipRef inClip )
    {
      var retval = SDK.FPClip_GetTotalSize( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_FetchNext( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_RawOpen( inPool, inClipID, inStream, inOptions );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_GetNumDescriptionAttributes( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_ValidateRetentionClass( inContextRef, inClipRef );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_GetRetentionHold( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_IsEBREnabled( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_GetEBRPeriod( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
    ...
    {
      var retval = SDK.FPClip_GetEBRClassName8( inClip );
      SDK.CheckAndThrowError();
      return retval;
    }
